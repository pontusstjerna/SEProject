...
public class ReportController {
    ...
    //private String location_berth = "511";
    ...
    public void reportCargoOpCommenced(@RequestBody PortCall portcall,
        ...
        System.out.println(portcall.getBerth());
        ServiceState state = ServiceStateBuilder.newBuilder()
                ...
                .time(dateTime)
                .timeType(timeType)
                .at("urn:mrn:stm:location:segot:BERTH:" + portcall.getBerth(), null)
                .build();
    ...
    public void reportDepartureVesselBerth(@RequestBody PortCall portcall,
        ...
        LocationState state = LocationStateBuilder.newBuilder()
                ...
                .time(dateTime)
                .timeType(timeType)
                .departureLocation("urn:mrn:stm:location:segot:BERTH:" + portcall.getBerth(), null)
                .build();
    ...
    public void reportArrivalVesselBerth(@RequestBody PortCall portcall,
        ...
        LocationState state = LocationStateBuilder.newBuilder()
                ...
                .time(dateTime)
                .timeType(timeType)
                .arrivalLocation("urn:mrn:stm:location:segot:BERTH:" + portcall.getBerth(), null)
                .build();
